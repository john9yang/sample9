...
public class BasicDetection {
    public static void forEachCollision1(Collection<Box> c, Consumer<Collision> collisionHandler ){
    ...
    public static void foreachCollision2(List<Box> l,Consumer<Collision> collisionHandler){
     ...
     */
    public static void forEachCollision3( Collection<Box> c,Consumer<Collision> collisionHandler ){
